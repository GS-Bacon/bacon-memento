...
/**************************************************************************/
/**
 * @brief Construct a new bacon_PyCamera object.
 *
 * @details Initializes the display with specified TFT parameters.
 *
 */
/**************************************************************************/
bacon_PyCamera::bacon_PyCamera(void)
 ...
 */
/**************************************************************************/
bool bacon_PyCamera::initSD(void) {
 ...
 */
/**************************************************************************/
bool bacon_PyCamera::initExpander(void) {
 ...
 */
/**************************************************************************/
bool bacon_PyCamera::initDisplay(void) {
 ...
 */
/**************************************************************************/
bool bacon_PyCamera::setFramesize(framesize_t framesize) {
 ...
 */
/**************************************************************************/
bool bacon_PyCamera::setSpecialEffect(uint8_t effect) {
 ...
 */
/**************************************************************************/
bool bacon_PyCamera::initCamera(bool hwreset) {
 ...
 */
/**************************************************************************/
float bacon_PyCamera::readBatteryVoltage(void) {
 ...
 */
/**************************************************************************/
bool bacon_PyCamera::SDdetected(void) {
 ...
 */
/**************************************************************************/
uint32_t bacon_PyCamera::readButtons(void) {
 ...
 */
/**************************************************************************/
bool bacon_PyCamera::justPressed(uint8_t button_pin) {
 ...
 */
/**************************************************************************/
bool bacon_PyCamera::justReleased(uint8_t button_pin) {
 ...
 */
/**************************************************************************/
void bacon_PyCamera::speaker_tone(uint32_t tonefreq, uint32_t tonetime) {
 ...
 */
/**************************************************************************/
bool bacon_PyCamera::takePhoto(const char *filename_base,
 ...
 */
/**************************************************************************/
uint32_t bacon_PyCamera::timestamp(void) {
 ...
 */
/**************************************************************************/
void bacon_PyCamera::timestampPrint(const char *msg) {
 ...
 */
/**************************************************************************/
bool bacon_PyCamera::captureFrame(void) {
 ...
 */
/**************************************************************************/
void bacon_PyCamera::blitFrame(void) {
 ...
 */
/**************************************************************************/
void bacon_PyCamera::refresh(void) { esp_camera_fb_return(frame); }
 ...
 */
/**************************************************************************/
bool bacon_PyCamera::initAccel(void) {
 ...
 */
/**************************************************************************/
bool bacon_PyCamera::readAccelData(int16_t *x, int16_t *y, int16_t *z) {
 ...
 */
/**************************************************************************/
bool bacon_PyCamera::readAccelData(float *x_g, float *y_g, float *z_g) {
  int16_t x, y, z;
 ...
 */
/**************************************************************************/
void bacon_PyCamera::I2Cscan(void) {
  Wire.begin();
 ...
 */
/**************************************************************************/
void bacon_PyCamera::setNeopixel(uint32_t c) {
  pixel.fill(c);
 ...
 */
/**************************************************************************/
void bacon_PyCamera::setRing(uint32_t c) {
  ring.fill(c);
...
*/
/**************************************************************************/
uint32_t bacon_PyCamera::Wheel(byte WheelPos) {
